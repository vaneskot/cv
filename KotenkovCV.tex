...
\cventry{Авг 2010 -- н.в.}{Инженер 1 кат.}{\textbf{ОАО НПО ЛЭМЗ}}{Москва}{}{Разработка программного обеспечения для управления воздушным движением.\newline{}%
Обязанности:
\begin{itemize}%
...
\cvlistitem{\textit{Библиотеки}: STL, Qt, OpenGL}
\cvlistitem{\textit{Остальное}: linux, vim, bash, svn, tex}
