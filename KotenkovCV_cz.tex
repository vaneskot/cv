...
Vytvořil jsem také program v C++ pro řešení a vizualizace tohoto problému, v kterém jsem použil několik metod řešení soustav lineárních rovnic.
}

\section{Pracovní zkušenosti}
\cventry{\small{Listopad 2016 -- Současnost}}{Principal Programátor}{\textbf{Yandex}}{Moskva}{}{Vývoj jádra renderování webového prohlížče Yandex.Browser.}
\cventry{\small{Září 2014 -- Říjen 2016}}{Senior Programátor}{\textbf{Yandex}}{Moskva}{}{Vývoj jádra renderování webového prohlížče Yandex.Browser.}
...
\cvlistitem{\textit{Systémy správy verzí}: git, svn}
